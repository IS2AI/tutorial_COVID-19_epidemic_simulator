...
# the object of class simulator contains the simulation and epidemic related parameters 
# and transition functions
sim = simulator.Simulator(0,20)   

# the object of class Particles contains parameters of particle
# and functions related to the update of those parameters
...
for i in range(sim.number_of_iter):
    ...
    particles.update_records(i, sim)
