...
if __name__ == "__main__":
    ...
    particles.update_records(1, simulator)
    ...
    if check_v_1.size==0 and check_x_1.size==0:
        print("Successfully passed positions update Test 1.")
    else: 
    ...
    if check_v_2.size==0 and check_x_2.size==0:
        print("Successfully passed positions update Test 2.")
    else: 
    ...
    if check_v_3.size==0 and check_x_3.size==0:
        print("Successfully passed positions update Test 3.")
    else: 
    ...
    if check_v_4.size==0 and check_x_4.size==0:
        print("Successfully passed positions update Test 4.")
    else: 
    ...
    if check_v_5.size==0 and check_x_5.size==0:
        print("Successfully passed positions update Test 5.")
    else: 
